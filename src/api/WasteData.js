...
export default class WasteData {
    _data = {};
    _date;
    _events = {
        changedate: [],
    ...
    async loadFromRemote() {
        const res = await axios.get(`${SERVER_BASE_URL}/waste/data`, {
            headers: {
                'Content-Type': 'application/json',
            },
        });

        this.loadWasteData(res.data);
    }

    async saveToRemote() {
        await axios.put(
            `${SERVER_BASE_URL}/waste/data`,
    ...
    async applyChangesToRemote() {
        // TODO: non ce n'è più bisogno
        await axios.post(`${SERVER_BASE_URL}/apply`);
    }
